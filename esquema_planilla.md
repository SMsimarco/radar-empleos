...
| `link` | texto | workflow |
| `estado` | texto | workflow — DESCARTAR / POSTULAR YA / MIRAR / NO_PARSEABLE (el modelo no devolvió JSON válido, o la llamada a Claude falló tras reintentos — revisar el link a mano) |
